...
<head>
    ...
    <title>{{ config('app.name')}} - Ingresar</title>
    <!-- Custom CSS -->
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    @endif
                    <form action="{{route("login")}}" id="loginform" class="form-horizontal m-t-20" method="POST" autocomplete="off">
                        @csrf
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="user" class="form-control form-control-lg" placeholder="Usuario" aria-label="Username" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
